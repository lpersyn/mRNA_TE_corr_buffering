...
generate_feature_importance_plot(
    feature_importance_path = "./results/human/RNA/lgbm-LL_P5_P3_CF_AAF_3mer_freq_5/feature_importance.csv",
    features_path = "./figures/human_features.csv",
    predictions_path = "./results/human/RNA/lgbm-LL_P5_P3_CF_AAF_3mer_freq_5/predictions.csv",
    top_k = 20,
    output_path = "./figures/RNA/human_feature_importance.pdf"
)

generate_feature_importance_plot(
    feature_importance_path = "./results/mouse/RNA/lgbm-LL_P5_P3_CF_AAF_3mer_freq_5/feature_importance.csv",
    features_path = "./figures/mouse_features.csv",
    predictions_path = "./results/mouse/RNA/lgbm-LL_P5_P3_CF_AAF_3mer_freq_5/predictions.csv",
    top_k = 20,
    output_path = "./figures/RNA/mouse_feature_importance.pdf"
)
