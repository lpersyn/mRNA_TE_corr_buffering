...
human_features <- read.csv("./results/human/TE/lgbm-LL_P5_P3_CF_AAF_3mer_freq_5/feature_importance.csv", 
  header = TRUE, sep = ","
)

mouse_features <- read.csv("./results/mouse/TE/lgbm-LL_P5_P3_CF_AAF_3mer_freq_5/feature_importance.csv", 
  header = TRUE, sep = ","
)
...
pdf("./figures/TE/human_mouse_feature_imp_corr.pdf", 5, 5) 
features %>% 
  mutate(
